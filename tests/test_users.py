...
sys.path.append('../demo') # imports python file from parent directory
...
class UsersTests(unittest.TestCase):
    ...
    def test_valid_user_registration(self):
        #We're sending input, username -test, email, password-FlaskIsAwesome
    ...
    def test_invalid_username_registration(self):
        ...
        response = self.register('01234567890123456789aa', 'abc@gmail.com', 'FlaskIsAwesome')
        self.assertIn(b'Field must be between 2 and 20 characters long.', response.data)
